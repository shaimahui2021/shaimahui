!function(t) {
    ...
    , , function(t, e, n) {
        ...
        var o = Object.prototype.hasOwnProperty
            ...
            if (!t || "[object Object]" !== r.call(t))
                return !1;
            var e, n = o.call(t, "constructor"), i = t.constructor && t.constructor.prototype && o.call(t.constructor.prototype, "isPrototypeOf");
    ...
    , function(t, e, n) {
        ...
        }, s = (o = document.referrer,
            r = location.href || document.URL,
            o = o.length > 512 ? o.substr(0, 512) : o,
            r = r.length > 1024 ? r.substr(0, 1024) : r,
            ["referer=" + encodeURIComponent(o), "href=" + encodeURIComponent(r)].join("&"));
        t.exports = {
            type: a,
            send: function(t, e, n) {
                try {
            ...
            for (var o = 0; o < t.length; o++) {
                ...
                if (i) {
                    ...
                    for (; a < r.parts.length; a++)
                        i.parts.push(l(r.parts[a], e))
                } else {
                    var c = [];
                    for (a = 0; a < r.parts.length; a++)
                        c.push(l(r.parts[a], e));
                    n[r.id] = {
                        id: r.id,
                        refs: 1,
                        parts: c
                    ...
                    "function" == typeof rep && (s = rep.call(e, t, s)),
                        ...
                        case "object":
                            ...
                            if (rep && "object" === (void 0 === rep ? "undefined" : _typeof(rep)))
                                for (i = rep.length,
                                         n = 0; n < i; n += 1)
                                    "string" == typeof rep[n] && (r = str(o = rep[n], s)) && a.push(quote(o) + (gap ? ": " : ":") + r);
                            else
                                for (o in s)
                                    Object.prototype.hasOwnProperty.call(s, o) && (r = str(o, s)) && a.push(quote(o) + (gap ? ": " : ":") + r);
                            return r = 0 === a.length ? "{}" : gap ? "{\n" + gap + a.join(",\n" + gap) + "\n" + c + "}" : "{" + a.join(",") + "}",
                                gap = c,
                                r
                    }
                ...
                "function" != typeof JSON.parse && (JSON.parse = function(text, reviver) {
                        ...
                        function walk(t, e) {
                            ...
                            if (r && "object" === (void 0 === r ? "undefined" : _typeof(r)))
                                for (n in r)
                                    Object.prototype.hasOwnProperty.call(r, n) && ((o = walk(r, n)) !== undefined ? r[n] = o : delete r[n]);
    ...
    , function(t, e, n) {
        ...
        function a(t, e, n) {
            var r = "";
            if (arguments.length < 2 ? r = "[Msger] error 1" : "object" != (void 0 === t ? "undefined" : o(t)) ? r = "[Msger] error 2" : "string" != typeof e && (r = "[Msger] error 3"),
                r)
                throw new Error(r);
            this.target = t,
                this.name = e,
        ...
        function c(t, e) {
            this.targets = {},
                this.name = t,
                this.listenFunc = [],
            "string" != typeof (r = e || r) && (r = r.toString()),
                this.initListen()
        }
    ...
    , , , , , , , , , , , , , , , , function(module, exports, __webpack_require__) {
        ...
        var Messenger = __webpack_require__(15)
            ...
            , grayscaleFrameJs = "/tcaptcha-frame.1b406056.js"
            ...
            if (needGrayscaleJs !== undefined)
                return needGrayscaleJs;
            for (var e = 0, n = grayscaleAppId.length; e < n; e++)
                if (t == grayscaleAppId[e])
                    return needGrayscaleJs = !0;
        ...
        Captcha.prototype = {
            ...
            __show__: function() {
                ...
                for (var n in e.push("aid=" + t.appid),
                    ...
                    e.push("ua=" + encodeURIComponent(btoa(navigator.userAgent))),
        ...
        executor.exec(function(t) {
            ...
            executor.exec(function(t) {
                jsLoadStatus = "loading",
                    needGrayscaleJs = !0,
                    loadScript(grayscaleFrameJs, capDomain, capDomain, function() {
    ...
    , function(t, e, n) {
        t.exports = function(t) {
            var e, n = [], o = document, r = o.documentElement, i = r.doScroll, a = (i ? /^loaded|^c/ : /^loaded|c/).test(o.readyState);
            function c(t) {
                for (a = 1; t = n.shift(); )
                    t()
            }
            return o.addEventListener && o.addEventListener("DOMContentLoaded", e = function() {
                ...
                , !1),
            i && o.attachEvent("onreadystatechange", e = function() {
                    /^c/.test(o.readyState) && (o.detachEvent("onreadystatechange", e),
                        c())
                }
            ),
                t = i ? function(e) {
